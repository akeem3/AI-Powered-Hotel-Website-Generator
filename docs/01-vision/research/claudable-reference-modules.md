...
**Status**: Reference Only (Not for Integration)

---

## Overview

Claudable provides working examples of LLM-driven web application generation that can inform our hotel website generator design. This document catalogs their main modules and concepts for reference during our own development.
