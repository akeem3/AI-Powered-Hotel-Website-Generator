...
// Load environment variables from web-app/.env FIRST, before any other imports
...
// Now we can safely import the batch generation script
// We'll inline the main logic here to avoid import issues
